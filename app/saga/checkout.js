...
import { POST_SUBSCRIPTION, NEW_CHECKOUT, NEW_CHECKOUT_TRY } from 'actions/constants'
...
export default function* sagaCheckout() {
  ...
  yield takeLatest(NEW_CHECKOUT_TRY, newCheckout)
  yield takeLatest(NEW_CHECKOUT, newCheckout)
}
